...
func TestCalculateProratedCredit(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     10_000_000,
			epochStartTime: time.Now().UTC().Add(-5 * time.Minute).Add(1 * time.Second),
			epochDuration:  time.Minute * 5,
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     10_000_000,
			epochStartTime: time.Now().UTC().Add(-1 * time.Second),
			epochDuration:  time.Minute * 5,
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     100,
			epochStartTime: time.Now().UTC().Add(-4 * time.Minute),
			epochDuration:  time.Minute * 5,
			expectedCredit: 80,
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     200,
			epochStartTime: time.Now().UTC().Add(-3 * time.Minute),
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     100,
			epochStartTime: time.Now().UTC().Add(-30 * time.Second),
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     100,
			epochStartTime: time.Now().UTC().Add(-10 * time.Minute),
			epochDuration:  time.Minute * 5,
			expectedCredit: 100,
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     9,
			epochStartTime: time.Now().UTC().Add(-3 * time.Second),
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     7,
			epochStartTime: time.Now().UTC().Add(-10 * time.Second),
		...
		},
		{
			...
			lockedAmt:      0,
			lockingAmt:     1234,
			epochStartTime: time.Now().UTC().Add(-4 * time.Second),
