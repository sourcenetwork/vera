...
var (
	...
	pattern_Query_Developers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcehub", "tier", "v1beta1", "developers"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UserSubscriptions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sourcehub", "tier", "v1beta1", "subscriptions", "developer"}, "", runtime.AssumeColonVerbOpt(false)))
)
