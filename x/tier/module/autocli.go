		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					Use:            "add-user-subscription [user] [amount] [period]",
					Short:          "Add a user subscription",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "user"}, {ProtoField: "amount"}, {ProtoField: "period"}},
				},
				{
					RpcMethod:      "UpdateUserSubscription",
					Use:            "update-user-subscription [user] [amount] [period]",
					Short:          "Update a user subscription",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "user"}, {ProtoField: "amount"}, {ProtoField: "period"}},
				},
				{
					RpcMethod:      "RemoveUserSubscription",
					Use:            "remove-user-subscription [user]",
