...
func (m *Params) GetRegistrationsCommitmentValiditySecs() uint64 {
	if m != nil {
		return m.RegistrationsCommitmentValiditySecs
	}
	return 0
}
...
var fileDescriptor_042bc00af41a360e = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.PolicyCommandMaxExpirationDelta != that1.PolicyCommandMaxExpirationDelta {
		return false
	}
	if this.RegistrationsCommitmentValiditySecs != that1.RegistrationsCommitmentValiditySecs {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.RegistrationsCommitmentValiditySecs != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.RegistrationsCommitmentValiditySecs))
		i--
		dAtA[i] = 0x10
	}
...
func (m *Params) Size() (n int) {
	...
	if m.RegistrationsCommitmentValiditySecs != 0 {
		n += 1 + sovParams(uint64(m.RegistrationsCommitmentValiditySecs))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegistrationsCommitmentValiditySecs", wireType)
			}
			m.RegistrationsCommitmentValiditySecs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RegistrationsCommitmentValiditySecs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
