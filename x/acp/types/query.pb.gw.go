...
func request_Query_RegistrationsCommitment_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryRegistrationsCommitment
	var metadata runtime.ServerMetadata
...
func request_Query_RegistrationsCommitmentByCommitment_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryRegistrationsCommitmentByCommitment
	var metadata runtime.ServerMetadata
...
var (
	...
	pattern_Query_RegistrationsCommitment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sourcenetwork", "sourcehub", "acp", "registration_commitments", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegistrationsCommitmentByCommitment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 4}, []string{"sourcenetwork", "sourcehub", "acp", "registration_commitments", "commitment"}, "", runtime.AssumeColonVerbOpt(false)))
)
