...
type RevealRegistrationResult int32

const (
	RevealRegistrationResult_NO_OP   RevealRegistrationResult = 0
	RevealRegistrationResult_CREATED RevealRegistrationResult = 1
	RevealRegistrationResult_AMENDED RevealRegistrationResult = 2
)

var RevealRegistrationResult_name = map[int32]string{
	0: "NO_OP",
	1: "CREATED",
	2: "AMENDED",
}

var RevealRegistrationResult_value = map[string]int32{
	"NO_OP":   0,
	"CREATED": 1,
	"AMENDED": 2,
}

func (x RevealRegistrationResult) String() string {
	return proto.EnumName(RevealRegistrationResult_name, int32(x))
}

func (RevealRegistrationResult) EnumDescriptor() ([]byte, []int) {
...
type RevealRegistrationCmdResult struct {
	Result RevealRegistrationResult `protobuf:"varint,1,opt,name=result,proto3,enum=sourcehub.acp.RevealRegistrationResult" json:"result,omitempty"`
...
func (m *RevealRegistrationCmdResult) GetResult() RevealRegistrationResult {
	if m != nil {
		return m.Result
	}
	return RevealRegistrationResult_NO_OP
}
...
func init() {
	proto.RegisterEnum("sourcehub.acp.RevealRegistrationResult", RevealRegistrationResult_name, RevealRegistrationResult_value)
...
var fileDescriptor_1de5e9736122d1ff = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Result |= RevealRegistrationResult(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
