...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcenetwork", "vera", "bulletin", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Namespace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3}, []string{"sourcenetwork", "vera", "bulletin", "namespace"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Namespaces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcenetwork", "vera", "bulletin", "namespaces"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NamespaceCollaborators_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sourcenetwork", "vera", "bulletin", "collaborators", "namespace"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NamespacePosts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sourcenetwork", "vera", "bulletin", "posts", "namespace"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Post_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"sourcenetwork", "vera", "bulletin", "post", "namespace", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Posts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcenetwork", "vera", "bulletin", "posts"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_IterateGlob_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcenetwork", "vera", "bulletin", "iterate_glob"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BulletinPolicyId_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcenetwork", "vera", "bulletin", "policy_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
