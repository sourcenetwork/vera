...
var _ sdk.Msg = &MsgAddNodeToWhitelist{}

func (msg *MsgAddNodeToWhitelist) ValidateBasic() error {
	...
	case *MsgAddNodeToWhitelist_PolicyId:
		if target.PolicyId == "" {
			return errorsmod.Wrap(ErrInvalidNodeInfo, "missing policy_id")
		}
	case *MsgAddNodeToWhitelist_RingId:
		if target.RingId == "" {
