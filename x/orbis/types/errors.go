...
var (
	...
	ErrRingNotFinalized           = sdkerrors.Register(ModuleName, 1228, "ring is not finalized")
	ErrUnauthorizedRingUpdate     = sdkerrors.Register(ModuleName, 1229, "actor is not authorized to update ring")
	ErrUnauthorizedRingCreate     = sdkerrors.Register(ModuleName, 1230, "actor is not authorized to create ring")
	ErrNodeWhitelistEntryExists   = sdkerrors.Register(ModuleName, 1231, "node whitelist entry already exists")
	ErrNodeWhitelistEntryNotFound = sdkerrors.Register(ModuleName, 1232, "node whitelist entry not found")
	ErrRingPssIntervalUnchanged   = sdkerrors.Register(ModuleName, 1233, "ring PSS interval is unchanged")
	ErrRingUpgradeNotScheduled    = sdkerrors.Register(ModuleName, 1234, "ring upgrade is not scheduled")
