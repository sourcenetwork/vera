...
var (
	...
	ErrNodeInfoUnchanged          = sdkerrors.Register(ModuleName, 1238, "node info value is unchanged")
	ErrRingUpgradeUnchanged       = sdkerrors.Register(ModuleName, 1239, "ring upgrade schedule is unchanged")
)
