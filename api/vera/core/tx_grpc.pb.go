...
const (
	Msg_UpdateParams_FullMethodName  = "/vera.core.Msg/UpdateParams"
	Msg_InvalidateJWS_FullMethodName = "/vera.core.Msg/InvalidateJWS"
)
...
func (UnimplementedMsgServer) InvalidateJWS(context.Context, *MsgInvalidateJWS) (*MsgInvalidateJWSResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InvalidateJWS not implemented")
}
