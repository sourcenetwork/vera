...
func init() {
	...
	md_ChainConfig = File_vera_core_chain_config_proto.Messages().ByName("ChainConfig")
...
func (x *ChainConfig) slowProtoReflect() protoreflect.Message {
	mi := &file_vera_core_chain_config_proto_msgTypes[0]
...
func (x *fastReflection_ChainConfig) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vera.core.ChainConfig.allow_zero_fee_txs":
		return x.AllowZeroFeeTxs != false
	case "vera.core.ChainConfig.ignore_bearer_auth":
		return x.IgnoreBearerAuth != false
	case "vera.core.ChainConfig.allow_any_relay":
		return x.AllowAnyRelay != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.core.ChainConfig"))
		}
		panic(fmt.Errorf("message vera.core.ChainConfig does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ChainConfig) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vera.core.ChainConfig does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ChainConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vera.core.ChainConfig.allow_zero_fee_txs":
		panic(fmt.Errorf("field allow_zero_fee_txs of message vera.core.ChainConfig is not mutable"))
	case "vera.core.ChainConfig.ignore_bearer_auth":
		panic(fmt.Errorf("field ignore_bearer_auth of message vera.core.ChainConfig is not mutable"))
	case "vera.core.ChainConfig.allow_any_relay":
		panic(fmt.Errorf("field allow_any_relay of message vera.core.ChainConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.core.ChainConfig"))
		}
...
func (x *fastReflection_ChainConfig) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vera.core.ChainConfig", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ChainConfig) Descriptor() ([]byte, []int) {
	return file_vera_core_chain_config_proto_rawDescGZIP(), []int{0}
}
...
var File_vera_core_chain_config_proto protoreflect.FileDescriptor

var file_vera_core_chain_config_proto_rawDesc = []byte{
	,
}

var (
	file_vera_core_chain_config_proto_rawDescOnce sync.Once
	file_vera_core_chain_config_proto_rawDescData = file_vera_core_chain_config_proto_rawDesc
)

func file_vera_core_chain_config_proto_rawDescGZIP() []byte {
	file_vera_core_chain_config_proto_rawDescOnce.Do(func() {
		file_vera_core_chain_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_vera_core_chain_config_proto_rawDescData)
	})
	return file_vera_core_chain_config_proto_rawDescData
}

var file_vera_core_chain_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vera_core_chain_config_proto_goTypes = []interface{}{
	(*ChainConfig)(nil), // 0: vera.core.ChainConfig
}
var file_vera_core_chain_config_proto_depIdxs = []int32{
...
func init() { file_vera_core_chain_config_proto_init() }
func file_vera_core_chain_config_proto_init() {
	if File_vera_core_chain_config_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_vera_core_chain_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vera_core_chain_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vera_core_chain_config_proto_goTypes,
		DependencyIndexes: file_vera_core_chain_config_proto_depIdxs,
		MessageInfos:      file_vera_core_chain_config_proto_msgTypes,
	}.Build()
	File_vera_core_chain_config_proto = out.File
	file_vera_core_chain_config_proto_rawDesc = nil
	file_vera_core_chain_config_proto_goTypes = nil
	file_vera_core_chain_config_proto_depIdxs = nil
}
