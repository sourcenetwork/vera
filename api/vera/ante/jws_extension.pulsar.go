...
func init() {
	file_vera_ante_jws_extension_proto_init()
	md_JWSExtensionOption = File_vera_ante_jws_extension_proto.Messages().ByName("JWSExtensionOption")
...
func (x *JWSExtensionOption) slowProtoReflect() protoreflect.Message {
	mi := &file_vera_ante_jws_extension_proto_msgTypes[0]
...
func (x *fastReflection_JWSExtensionOption) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vera.ante.JWSExtensionOption.bearer_token":
		return x.BearerToken != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.ante.JWSExtensionOption"))
		}
		panic(fmt.Errorf("message vera.ante.JWSExtensionOption does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_JWSExtensionOption) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vera.ante.JWSExtensionOption does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_JWSExtensionOption) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vera.ante.JWSExtensionOption.bearer_token":
		panic(fmt.Errorf("field bearer_token of message vera.ante.JWSExtensionOption is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.ante.JWSExtensionOption"))
		}
...
func (x *fastReflection_JWSExtensionOption) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vera.ante.JWSExtensionOption", d.FullName()))
	}
	panic("unreachable")
}
...
func (*JWSExtensionOption) Descriptor() ([]byte, []int) {
	return file_vera_ante_jws_extension_proto_rawDescGZIP(), []int{0}
}
...
var File_vera_ante_jws_extension_proto protoreflect.FileDescriptor

var file_vera_ante_jws_extension_proto_rawDesc = []byte{
	,
}

var (
	file_vera_ante_jws_extension_proto_rawDescOnce sync.Once
	file_vera_ante_jws_extension_proto_rawDescData = file_vera_ante_jws_extension_proto_rawDesc
)

func file_vera_ante_jws_extension_proto_rawDescGZIP() []byte {
	file_vera_ante_jws_extension_proto_rawDescOnce.Do(func() {
		file_vera_ante_jws_extension_proto_rawDescData = protoimpl.X.CompressGZIP(file_vera_ante_jws_extension_proto_rawDescData)
	})
	return file_vera_ante_jws_extension_proto_rawDescData
}

var file_vera_ante_jws_extension_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vera_ante_jws_extension_proto_goTypes = []interface{}{
	(*JWSExtensionOption)(nil), // 0: vera.ante.JWSExtensionOption
}
var file_vera_ante_jws_extension_proto_depIdxs = []int32{
...
func init() { file_vera_ante_jws_extension_proto_init() }
func file_vera_ante_jws_extension_proto_init() {
	if File_vera_ante_jws_extension_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_vera_ante_jws_extension_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vera_ante_jws_extension_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vera_ante_jws_extension_proto_goTypes,
		DependencyIndexes: file_vera_ante_jws_extension_proto_depIdxs,
		MessageInfos:      file_vera_ante_jws_extension_proto_msgTypes,
	}.Build()
	File_vera_ante_jws_extension_proto = out.File
	file_vera_ante_jws_extension_proto_rawDesc = nil
	file_vera_ante_jws_extension_proto_goTypes = nil
	file_vera_ante_jws_extension_proto_depIdxs = nil
}
