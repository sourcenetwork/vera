...
func init() {
	...
	md_Post = File_vera_bulletin_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_vera_bulletin_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vera.bulletin.Post.id":
		return x.Id != ""
	case "vera.bulletin.Post.namespace":
		return x.Namespace != ""
	case "vera.bulletin.Post.creator_did":
		return x.CreatorDid != ""
	case "vera.bulletin.Post.payload":
		return len(x.Payload) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.bulletin.Post"))
		}
		panic(fmt.Errorf("message vera.bulletin.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vera.bulletin.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vera.bulletin.Post.id":
		panic(fmt.Errorf("field id of message vera.bulletin.Post is not mutable"))
	case "vera.bulletin.Post.namespace":
		panic(fmt.Errorf("field namespace of message vera.bulletin.Post is not mutable"))
	case "vera.bulletin.Post.creator_did":
		panic(fmt.Errorf("field creator_did of message vera.bulletin.Post is not mutable"))
	case "vera.bulletin.Post.payload":
		panic(fmt.Errorf("field payload of message vera.bulletin.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.bulletin.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vera.bulletin.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_vera_bulletin_post_proto_rawDescGZIP(), []int{0}
}
...
var File_vera_bulletin_post_proto protoreflect.FileDescriptor

var file_vera_bulletin_post_proto_rawDesc = []byte{
	0x0a, 0x18, 0x76, 0x65, 0x72, 0x61, 0x2f, 0x62, 0x75, 0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0x2f,
	0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x76, 0x65, 0x72, 0x61,
	0x2e, 0x62, 0x75, 0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0x22, 0x6f, 0x0a, 0x04, 0x50, 0x6f, 0x73,
	...
	,
}

var (
	file_vera_bulletin_post_proto_rawDescOnce sync.Once
	file_vera_bulletin_post_proto_rawDescData = file_vera_bulletin_post_proto_rawDesc
)

func file_vera_bulletin_post_proto_rawDescGZIP() []byte {
	file_vera_bulletin_post_proto_rawDescOnce.Do(func() {
		file_vera_bulletin_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_vera_bulletin_post_proto_rawDescData)
	})
	return file_vera_bulletin_post_proto_rawDescData
}

var file_vera_bulletin_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vera_bulletin_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: vera.bulletin.Post
}
var file_vera_bulletin_post_proto_depIdxs = []int32{
...
func init() { file_vera_bulletin_post_proto_init() }
func file_vera_bulletin_post_proto_init() {
	if File_vera_bulletin_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_vera_bulletin_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vera_bulletin_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vera_bulletin_post_proto_goTypes,
		DependencyIndexes: file_vera_bulletin_post_proto_depIdxs,
		MessageInfos:      file_vera_bulletin_post_proto_msgTypes,
	}.Build()
	File_vera_bulletin_post_proto = out.File
	file_vera_bulletin_post_proto_rawDesc = nil
	file_vera_bulletin_post_proto_goTypes = nil
	file_vera_bulletin_post_proto_depIdxs = nil
}
