...
func init() {
	...
	md_Collaborator = File_vera_bulletin_collaborator_proto.Messages().ByName("Collaborator")
...
func (x *Collaborator) slowProtoReflect() protoreflect.Message {
	mi := &file_vera_bulletin_collaborator_proto_msgTypes[0]
...
func (x *fastReflection_Collaborator) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vera.bulletin.Collaborator.address":
		return x.Address != ""
	case "vera.bulletin.Collaborator.did":
		return x.Did != ""
	case "vera.bulletin.Collaborator.namespace":
		return x.Namespace != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.bulletin.Collaborator"))
		}
		panic(fmt.Errorf("message vera.bulletin.Collaborator does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Collaborator) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vera.bulletin.Collaborator does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Collaborator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vera.bulletin.Collaborator.address":
		panic(fmt.Errorf("field address of message vera.bulletin.Collaborator is not mutable"))
	case "vera.bulletin.Collaborator.did":
		panic(fmt.Errorf("field did of message vera.bulletin.Collaborator is not mutable"))
	case "vera.bulletin.Collaborator.namespace":
		panic(fmt.Errorf("field namespace of message vera.bulletin.Collaborator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.bulletin.Collaborator"))
		}
...
func (x *fastReflection_Collaborator) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vera.bulletin.Collaborator", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: vera/bulletin/collaborator.proto
...
func (*Collaborator) Descriptor() ([]byte, []int) {
	return file_vera_bulletin_collaborator_proto_rawDescGZIP(), []int{0}
}
...
var File_vera_bulletin_collaborator_proto protoreflect.FileDescriptor

var file_vera_bulletin_collaborator_proto_rawDesc = []byte{
	,
...
var (
	file_vera_bulletin_collaborator_proto_rawDescOnce sync.Once
	file_vera_bulletin_collaborator_proto_rawDescData = file_vera_bulletin_collaborator_proto_rawDesc
)

func file_vera_bulletin_collaborator_proto_rawDescGZIP() []byte {
	file_vera_bulletin_collaborator_proto_rawDescOnce.Do(func() {
		file_vera_bulletin_collaborator_proto_rawDescData = protoimpl.X.CompressGZIP(file_vera_bulletin_collaborator_proto_rawDescData)
	})
	return file_vera_bulletin_collaborator_proto_rawDescData
}

var file_vera_bulletin_collaborator_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vera_bulletin_collaborator_proto_goTypes = []interface{}{
	(*Collaborator)(nil), // 0: vera.bulletin.Collaborator
}
var file_vera_bulletin_collaborator_proto_depIdxs = []int32{
...
func init() { file_vera_bulletin_collaborator_proto_init() }
func file_vera_bulletin_collaborator_proto_init() {
	if File_vera_bulletin_collaborator_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_vera_bulletin_collaborator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vera_bulletin_collaborator_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vera_bulletin_collaborator_proto_goTypes,
		DependencyIndexes: file_vera_bulletin_collaborator_proto_depIdxs,
		MessageInfos:      file_vera_bulletin_collaborator_proto_msgTypes,
	}.Build()
	File_vera_bulletin_collaborator_proto = out.File
	file_vera_bulletin_collaborator_proto_rawDesc = nil
	file_vera_bulletin_collaborator_proto_goTypes = nil
	file_vera_bulletin_collaborator_proto_depIdxs = nil
}
