...
const (
	Query_Params_FullMethodName                 = "/vera.bulletin.Query/Params"
	Query_Namespace_FullMethodName              = "/vera.bulletin.Query/Namespace"
	Query_Namespaces_FullMethodName             = "/vera.bulletin.Query/Namespaces"
	Query_NamespaceCollaborators_FullMethodName = "/vera.bulletin.Query/NamespaceCollaborators"
	Query_NamespacePosts_FullMethodName         = "/vera.bulletin.Query/NamespacePosts"
	Query_Post_FullMethodName                   = "/vera.bulletin.Query/Post"
	Query_Posts_FullMethodName                  = "/vera.bulletin.Query/Posts"
	Query_IterateGlob_FullMethodName            = "/vera.bulletin.Query/IterateGlob"
	Query_BulletinPolicyId_FullMethodName       = "/vera.bulletin.Query/BulletinPolicyId"
)
...
func (UnimplementedQueryServer) Namespace(context.Context, *QueryNamespaceRequest) (*QueryNamespaceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Namespace not implemented")
}
func (UnimplementedQueryServer) Namespaces(context.Context, *QueryNamespacesRequest) (*QueryNamespacesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Namespaces not implemented")
}
func (UnimplementedQueryServer) NamespaceCollaborators(context.Context, *QueryNamespaceCollaboratorsRequest) (*QueryNamespaceCollaboratorsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NamespaceCollaborators not implemented")
}
func (UnimplementedQueryServer) NamespacePosts(context.Context, *QueryNamespacePostsRequest) (*QueryNamespacePostsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NamespacePosts not implemented")
}
...
func (UnimplementedQueryServer) IterateGlob(context.Context, *QueryIterateGlobRequest) (*QueryIterateGlobResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IterateGlob not implemented")
}
func (UnimplementedQueryServer) BulletinPolicyId(context.Context, *QueryBulletinPolicyIdRequest) (*QueryBulletinPolicyIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BulletinPolicyId not implemented")
}
