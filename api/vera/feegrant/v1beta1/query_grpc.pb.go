...
const (
	Query_Allowance_FullMethodName              = "/vera.feegrant.v1beta1.Query/Allowance"
	Query_Allowances_FullMethodName             = "/vera.feegrant.v1beta1.Query/Allowances"
	Query_AllowancesByGranter_FullMethodName    = "/vera.feegrant.v1beta1.Query/AllowancesByGranter"
	Query_DIDAllowance_FullMethodName           = "/vera.feegrant.v1beta1.Query/DIDAllowance"
	Query_DIDAllowances_FullMethodName          = "/vera.feegrant.v1beta1.Query/DIDAllowances"
	Query_DIDAllowancesByGranter_FullMethodName = "/vera.feegrant.v1beta1.Query/DIDAllowancesByGranter"
)
...
func (UnimplementedQueryServer) Allowances(context.Context, *QueryAllowancesRequest) (*QueryAllowancesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Allowances not implemented")
}
func (UnimplementedQueryServer) AllowancesByGranter(context.Context, *QueryAllowancesByGranterRequest) (*QueryAllowancesByGranterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AllowancesByGranter not implemented")
}
func (UnimplementedQueryServer) DIDAllowance(context.Context, *QueryDIDAllowanceRequest) (*QueryDIDAllowanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DIDAllowance not implemented")
}
func (UnimplementedQueryServer) DIDAllowances(context.Context, *QueryDIDAllowancesRequest) (*QueryDIDAllowancesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DIDAllowances not implemented")
}
func (UnimplementedQueryServer) DIDAllowancesByGranter(context.Context, *QueryDIDAllowancesByGranterRequest) (*QueryDIDAllowancesByGranterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DIDAllowancesByGranter not implemented")
}
