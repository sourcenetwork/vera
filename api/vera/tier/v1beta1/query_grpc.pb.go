...
const (
	Query_Params_FullMethodName            = "/vera.tier.v1beta1.Query/Params"
	Query_Lockup_FullMethodName            = "/vera.tier.v1beta1.Query/Lockup"
	Query_Lockups_FullMethodName           = "/vera.tier.v1beta1.Query/Lockups"
	Query_UnlockingLockup_FullMethodName   = "/vera.tier.v1beta1.Query/UnlockingLockup"
	Query_UnlockingLockups_FullMethodName  = "/vera.tier.v1beta1.Query/UnlockingLockups"
	Query_Developers_FullMethodName        = "/vera.tier.v1beta1.Query/Developers"
	Query_Developer_FullMethodName         = "/vera.tier.v1beta1.Query/Developer"
	Query_UserSubscriptions_FullMethodName = "/vera.tier.v1beta1.Query/UserSubscriptions"
)
