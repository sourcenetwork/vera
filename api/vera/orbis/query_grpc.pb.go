...
func (UnimplementedQueryServer) Rings(context.Context, *QueryRingsRequest) (*QueryRingsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Rings not implemented")
}
...
func (UnimplementedQueryServer) Documents(context.Context, *QueryDocumentsRequest) (*QueryDocumentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Documents not implemented")
}
func (UnimplementedQueryServer) KeyDerivation(context.Context, *QueryKeyDerivationRequest) (*QueryKeyDerivationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method KeyDerivation not implemented")
}
func (UnimplementedQueryServer) KeyDerivations(context.Context, *QueryKeyDerivationsRequest) (*QueryKeyDerivationsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method KeyDerivations not implemented")
}
