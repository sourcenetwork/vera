...
func init() {
	file_vera_acp_access_ticket_proto_init()
	md_AccessTicket = File_vera_acp_access_ticket_proto.Messages().ByName("AccessTicket")
...
func (x *AccessTicket) slowProtoReflect() protoreflect.Message {
	mi := &file_vera_acp_access_ticket_proto_msgTypes[0]
...
func (x *fastReflection_AccessTicket) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vera.acp.AccessTicket.version_denominator":
		return x.VersionDenominator != ""
	case "vera.acp.AccessTicket.decision_id":
		return x.DecisionId != ""
	case "vera.acp.AccessTicket.decision":
		return x.Decision != nil
	case "vera.acp.AccessTicket.decision_proof":
		return len(x.DecisionProof) != 0
	case "vera.acp.AccessTicket.signature":
		return len(x.Signature) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.acp.AccessTicket"))
		}
		panic(fmt.Errorf("message vera.acp.AccessTicket does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccessTicket) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vera.acp.AccessTicket does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccessTicket) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vera.acp.AccessTicket.version_denominator":
		panic(fmt.Errorf("field version_denominator of message vera.acp.AccessTicket is not mutable"))
	case "vera.acp.AccessTicket.decision_id":
		panic(fmt.Errorf("field decision_id of message vera.acp.AccessTicket is not mutable"))
	case "vera.acp.AccessTicket.decision_proof":
		panic(fmt.Errorf("field decision_proof of message vera.acp.AccessTicket is not mutable"))
	case "vera.acp.AccessTicket.signature":
		panic(fmt.Errorf("field signature of message vera.acp.AccessTicket is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.acp.AccessTicket"))
		}
...
func (x *fastReflection_AccessTicket) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vera.acp.AccessTicket", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: vera/acp/access_ticket.proto
...
func (*AccessTicket) Descriptor() ([]byte, []int) {
	return file_vera_acp_access_ticket_proto_rawDescGZIP(), []int{0}
}
...
var File_vera_acp_access_ticket_proto protoreflect.FileDescriptor

var file_vera_acp_access_ticket_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x76, 0x65, 0x72, 0x61, 0x2f, 0x61, 0x63, 0x70, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x5f, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08,
	0x76, 0x65, 0x72, 0x61, 0x2e, 0x61, 0x63, 0x70, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72,
	...
	,
}

var (
	file_vera_acp_access_ticket_proto_rawDescOnce sync.Once
	file_vera_acp_access_ticket_proto_rawDescData = file_vera_acp_access_ticket_proto_rawDesc
)

func file_vera_acp_access_ticket_proto_rawDescGZIP() []byte {
	file_vera_acp_access_ticket_proto_rawDescOnce.Do(func() {
		file_vera_acp_access_ticket_proto_rawDescData = protoimpl.X.CompressGZIP(file_vera_acp_access_ticket_proto_rawDescData)
	})
	return file_vera_acp_access_ticket_proto_rawDescData
}

var file_vera_acp_access_ticket_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vera_acp_access_ticket_proto_goTypes = []interface{}{
	(*AccessTicket)(nil),   // 0: vera.acp.AccessTicket
	(*AccessDecision)(nil), // 1: vera.acp.AccessDecision
}
var file_vera_acp_access_ticket_proto_depIdxs = []int32{
	1, // 0: vera.acp.AccessTicket.decision:type_name -> vera.acp.AccessDecision
...
func init() { file_vera_acp_access_ticket_proto_init() }
func file_vera_acp_access_ticket_proto_init() {
	if File_vera_acp_access_ticket_proto != nil {
		return
	}
	file_vera_acp_access_decision_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_vera_acp_access_ticket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vera_acp_access_ticket_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vera_acp_access_ticket_proto_goTypes,
		DependencyIndexes: file_vera_acp_access_ticket_proto_depIdxs,
		MessageInfos:      file_vera_acp_access_ticket_proto_msgTypes,
	}.Build()
	File_vera_acp_access_ticket_proto = out.File
	file_vera_acp_access_ticket_proto_rawDesc = nil
	file_vera_acp_access_ticket_proto_goTypes = nil
	file_vera_acp_access_ticket_proto_depIdxs = nil
}
