...
const (
	Msg_UpdateParams_FullMethodName    = "/vera.acp.Msg/UpdateParams"
	Msg_CreatePolicy_FullMethodName    = "/vera.acp.Msg/CreatePolicy"
	Msg_EditPolicy_FullMethodName      = "/vera.acp.Msg/EditPolicy"
	Msg_CheckAccess_FullMethodName     = "/vera.acp.Msg/CheckAccess"
	Msg_SignedPolicyCmd_FullMethodName = "/vera.acp.Msg/SignedPolicyCmd"
	Msg_BearerPolicyCmd_FullMethodName = "/vera.acp.Msg/BearerPolicyCmd"
	Msg_DirectPolicyCmd_FullMethodName = "/vera.acp.Msg/DirectPolicyCmd"
)
...
func (UnimplementedMsgServer) EditPolicy(context.Context, *MsgEditPolicy) (*MsgEditPolicyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EditPolicy not implemented")
}
...
func (UnimplementedMsgServer) SignedPolicyCmd(context.Context, *MsgSignedPolicyCmd) (*MsgSignedPolicyCmdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignedPolicyCmd not implemented")
}
func (UnimplementedMsgServer) BearerPolicyCmd(context.Context, *MsgBearerPolicyCmd) (*MsgBearerPolicyCmdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BearerPolicyCmd not implemented")
}
func (UnimplementedMsgServer) DirectPolicyCmd(context.Context, *MsgDirectPolicyCmd) (*MsgDirectPolicyCmdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DirectPolicyCmd not implemented")
}
