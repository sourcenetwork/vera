...
func init() {
	...
	md_AmendmentEvent = File_vera_acp_registration_proto.Messages().ByName("AmendmentEvent")
...
func (x *AmendmentEvent) slowProtoReflect() protoreflect.Message {
	mi := &file_vera_acp_registration_proto_msgTypes[0]
...
func (x *fastReflection_AmendmentEvent) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vera.acp.AmendmentEvent.id":
		return x.Id != uint64(0)
	case "vera.acp.AmendmentEvent.policy_id":
		return x.PolicyId != ""
	case "vera.acp.AmendmentEvent.object":
		return x.Object != nil
	case "vera.acp.AmendmentEvent.new_owner":
		return x.NewOwner != nil
	case "vera.acp.AmendmentEvent.previous_owner":
		return x.PreviousOwner != nil
	case "vera.acp.AmendmentEvent.commitment_id":
		return x.CommitmentId != uint64(0)
	case "vera.acp.AmendmentEvent.hijack_flag":
		return x.HijackFlag != false
	case "vera.acp.AmendmentEvent.metadata":
		return x.Metadata != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.acp.AmendmentEvent"))
		}
		panic(fmt.Errorf("message vera.acp.AmendmentEvent does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AmendmentEvent) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message vera.acp.AmendmentEvent does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AmendmentEvent) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vera.acp.AmendmentEvent.id":
		panic(fmt.Errorf("field id of message vera.acp.AmendmentEvent is not mutable"))
	case "vera.acp.AmendmentEvent.policy_id":
		panic(fmt.Errorf("field policy_id of message vera.acp.AmendmentEvent is not mutable"))
	case "vera.acp.AmendmentEvent.commitment_id":
		panic(fmt.Errorf("field commitment_id of message vera.acp.AmendmentEvent is not mutable"))
	case "vera.acp.AmendmentEvent.hijack_flag":
		panic(fmt.Errorf("field hijack_flag of message vera.acp.AmendmentEvent is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vera.acp.AmendmentEvent"))
		}
...
func (x *fastReflection_AmendmentEvent) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vera.acp.AmendmentEvent", d.FullName()))
	}
	panic("unreachable")
}
...
func (*AmendmentEvent) Descriptor() ([]byte, []int) {
	return file_vera_acp_registration_proto_rawDescGZIP(), []int{0}
}
...
var File_vera_acp_registration_proto protoreflect.FileDescriptor

var file_vera_acp_registration_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x76, 0x65, 0x72, 0x61, 0x2f, 0x61, 0x63, 0x70, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x76,
	0x65, 0x72, 0x61, 0x2e, 0x61, 0x63, 0x70, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x15, 0x76, 0x65, 0x72, 0x61, 0x2f, 0x61,
	0x63, 0x70, 0x2f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	...
	0xf3, 0x02, 0x0a, 0x0e, 0x41, 0x6d, 0x65, 0x6e, 0x64, 0x6d, 0x65, 0x6e, 0x74, 0x45, 0x76, 0x65,
	...
	0x36, 0x0a, 0x06, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
}

var (
	file_vera_acp_registration_proto_rawDescOnce sync.Once
	file_vera_acp_registration_proto_rawDescData = file_vera_acp_registration_proto_rawDesc
)

func file_vera_acp_registration_proto_rawDescGZIP() []byte {
	file_vera_acp_registration_proto_rawDescOnce.Do(func() {
		file_vera_acp_registration_proto_rawDescData = protoimpl.X.CompressGZIP(file_vera_acp_registration_proto_rawDescData)
	})
	return file_vera_acp_registration_proto_rawDescData
}

var file_vera_acp_registration_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_vera_acp_registration_proto_goTypes = []interface{}{
	(*AmendmentEvent)(nil), // 0: vera.acp.AmendmentEvent
	(*types.Object)(nil),   // 1: sourcenetwork.acp_core.Object
	(*types.Actor)(nil),    // 2: sourcenetwork.acp_core.Actor
	(*RecordMetadata)(nil), // 3: vera.acp.RecordMetadata
}
var file_vera_acp_registration_proto_depIdxs = []int32{
	1, // 0: vera.acp.AmendmentEvent.object:type_name -> sourcenetwork.acp_core.Object
	2, // 1: vera.acp.AmendmentEvent.new_owner:type_name -> sourcenetwork.acp_core.Actor
	2, // 2: vera.acp.AmendmentEvent.previous_owner:type_name -> sourcenetwork.acp_core.Actor
	3, // 3: vera.acp.AmendmentEvent.metadata:type_name -> vera.acp.RecordMetadata
...
func init() { file_vera_acp_registration_proto_init() }
func file_vera_acp_registration_proto_init() {
	if File_vera_acp_registration_proto != nil {
		return
	}
	file_vera_acp_record_proto_init()
	file_vera_acp_time_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_vera_acp_registration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_vera_acp_registration_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vera_acp_registration_proto_goTypes,
		DependencyIndexes: file_vera_acp_registration_proto_depIdxs,
		MessageInfos:      file_vera_acp_registration_proto_msgTypes,
	}.Build()
	File_vera_acp_registration_proto = out.File
	file_vera_acp_registration_proto_rawDesc = nil
	file_vera_acp_registration_proto_goTypes = nil
	file_vera_acp_registration_proto_depIdxs = nil
}
