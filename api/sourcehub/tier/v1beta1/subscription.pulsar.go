...
func (x *fastReflection_UserSubscription) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CreditAmount != nil {
		value := protoreflect.ValueOfMessage(x.CreditAmount.ProtoReflect())
...
func (x *fastReflection_UserSubscription) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "sourcehub.tier.v1beta1.UserSubscription.credit_amount":
		x.CreditAmount = value.Message().Interface().(*v1beta1.Coin)
	case "sourcehub.tier.v1beta1.UserSubscription.period":
		x.Period = value.Uint()
	case "sourcehub.tier.v1beta1.UserSubscription.start_date":
...
func (x *fastReflection_UserSubscription) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sourcehub.tier.v1beta1.UserSubscription.credit_amount":
		if x.CreditAmount == nil {
			x.CreditAmount = new(v1beta1.Coin)
		}
		return protoreflect.ValueOfMessage(x.CreditAmount.ProtoReflect())
	case "sourcehub.tier.v1beta1.UserSubscription.start_date":
		if x.StartDate == nil {
...
func (x *fastReflection_UserSubscription) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.CreditAmount != nil {
			encoded, err := options.Marshal(x.CreditAmount)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				if x.CreditAmount == nil {
					x.CreditAmount = &v1beta1.Coin{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.CreditAmount); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 4:
...
func (x *fastReflection_TotalDevGranted) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TotalGranted != nil {
		value := protoreflect.ValueOfMessage(x.TotalGranted.ProtoReflect())
...
func (x *fastReflection_TotalDevGranted) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "sourcehub.tier.v1beta1.TotalDevGranted.developer":
		x.Developer = value.Interface().(string)
	case "sourcehub.tier.v1beta1.TotalDevGranted.total_granted":
		x.TotalGranted = value.Message().Interface().(*v1beta1.Coin)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.tier.v1beta1.TotalDevGranted"))
		}
...
func (x *fastReflection_TotalDevGranted) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sourcehub.tier.v1beta1.TotalDevGranted.total_granted":
		if x.TotalGranted == nil {
			x.TotalGranted = new(v1beta1.Coin)
		}
		return protoreflect.ValueOfMessage(x.TotalGranted.ProtoReflect())
	case "sourcehub.tier.v1beta1.TotalDevGranted.developer":
...
func (x *fastReflection_TotalDevGranted) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TotalGranted != nil {
			encoded, err := options.Marshal(x.TotalGranted)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				if x.TotalGranted == nil {
					x.TotalGranted = &v1beta1.Coin{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TotalGranted); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type UserSubscription struct {
	...
	CreditAmount *v1beta1.Coin `protobuf:"bytes,3,opt,name=credit_amount,json=creditAmount,proto3" json:"credit_amount,omitempty"`
...
func (x *UserSubscription) GetCreditAmount() *v1beta1.Coin {
	if x != nil {
...
type TotalDevGranted struct {
	...
	TotalGranted *v1beta1.Coin `protobuf:"bytes,2,opt,name=total_granted,json=totalGranted,proto3" json:"total_granted,omitempty"`
}
...
func (x *TotalDevGranted) GetTotalGranted() *v1beta1.Coin {
	if x != nil {
...
var file_sourcehub_tier_v1beta1_subscription_proto_rawDesc = []byte{
	...
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0xe0, 0x02, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x53, 0x75,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x44, 0x69, 0x64, 0x12, 0x49, 0x0a,
	...
	0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x0c, 0x63, 0x72, 0x65, 0x64,
	...
	0x74, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x65, 0x64, 0x22, 0x94, 0x01, 0x0a, 0x0f, 0x54, 0x6f, 0x74,
	0x61, 0x6c, 0x44, 0x65, 0x76, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x64, 0x12, 0x36, 0x0a, 0x09,
	...
	0x6f, 0x70, 0x65, 0x72, 0x12, 0x49, 0x0a, 0x0d, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x67, 0x72,
	0x61, 0x6e, 0x74, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a,
	0x01, 0x52, 0x0c, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x64, 0x42,
	0xde, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75,
	0x62, 0x2e, 0x74, 0x69, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x11,
	...
	,
...
var file_sourcehub_tier_v1beta1_subscription_proto_depIdxs = []int32{
	3, // 0: sourcehub.tier.v1beta1.UserSubscription.credit_amount:type_name -> cosmos.base.v1beta1.Coin
	4, // 1: sourcehub.tier.v1beta1.UserSubscription.start_date:type_name -> google.protobuf.Timestamp
	4, // 2: sourcehub.tier.v1beta1.UserSubscription.last_renewed:type_name -> google.protobuf.Timestamp
	3, // 3: sourcehub.tier.v1beta1.TotalDevGranted.total_granted:type_name -> cosmos.base.v1beta1.Coin
