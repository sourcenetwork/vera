...
func init() {
	...
	md_ICAConnection = File_sourcehub_ica_ica_connection_proto.Messages().ByName("ICAConnection")
...
func (x *ICAConnection) slowProtoReflect() protoreflect.Message {
	mi := &file_sourcehub_ica_ica_connection_proto_msgTypes[0]
...
func (x *fastReflection_ICAConnection) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sourcehub.ica.ICAConnection.ica_address":
		return x.IcaAddress != ""
	case "sourcehub.ica.ICAConnection.controller_address":
		return x.ControllerAddress != ""
	case "sourcehub.ica.ICAConnection.controller_chain_id":
		return x.ControllerChainId != ""
	case "sourcehub.ica.ICAConnection.connection_id":
		return x.ConnectionId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.ica.ICAConnection"))
		}
		panic(fmt.Errorf("message sourcehub.ica.ICAConnection does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ICAConnection) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sourcehub.ica.ICAConnection does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ICAConnection) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sourcehub.ica.ICAConnection.ica_address":
		panic(fmt.Errorf("field ica_address of message sourcehub.ica.ICAConnection is not mutable"))
	case "sourcehub.ica.ICAConnection.controller_address":
		panic(fmt.Errorf("field controller_address of message sourcehub.ica.ICAConnection is not mutable"))
	case "sourcehub.ica.ICAConnection.controller_chain_id":
		panic(fmt.Errorf("field controller_chain_id of message sourcehub.ica.ICAConnection is not mutable"))
	case "sourcehub.ica.ICAConnection.connection_id":
		panic(fmt.Errorf("field connection_id of message sourcehub.ica.ICAConnection is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.ica.ICAConnection"))
		}
...
func (x *fastReflection_ICAConnection) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sourcehub.ica.ICAConnection", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: sourcehub/ica/ica_connection.proto
...
func (*ICAConnection) Descriptor() ([]byte, []int) {
	return file_sourcehub_ica_ica_connection_proto_rawDescGZIP(), []int{0}
}
...
var File_sourcehub_ica_ica_connection_proto protoreflect.FileDescriptor

var file_sourcehub_ica_ica_connection_proto_rawDesc = []byte{
	0x0a, 0x22, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2f, 0x69, 0x63, 0x61, 0x2f,
	...
	0x69, 0x63, 0x61, 0x22, 0xb4, 0x01, 0x0a, 0x0d, 0x49, 0x43, 0x41, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	...
	0x6f, 0x6d, 0x2e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2e, 0x69, 0x63, 0x61,
	...
	0x75, 0x62, 0x2f, 0x69, 0x63, 0x61, 0xa2, 0x02, 0x03, 0x53, 0x49, 0x58, 0xaa, 0x02, 0x0d, 0x53,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2e, 0x49, 0x63, 0x61, 0xca, 0x02, 0x0d, 0x53,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x5c, 0x49, 0x63, 0x61, 0xe2, 0x02, 0x19, 0x53,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x5c, 0x49, 0x63, 0x61, 0x5c, 0x47, 0x50, 0x42,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x53, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x68, 0x75, 0x62, 0x3a, 0x3a, 0x49, 0x63, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_sourcehub_ica_ica_connection_proto_rawDescOnce sync.Once
	file_sourcehub_ica_ica_connection_proto_rawDescData = file_sourcehub_ica_ica_connection_proto_rawDesc
)

func file_sourcehub_ica_ica_connection_proto_rawDescGZIP() []byte {
	file_sourcehub_ica_ica_connection_proto_rawDescOnce.Do(func() {
		file_sourcehub_ica_ica_connection_proto_rawDescData = protoimpl.X.CompressGZIP(file_sourcehub_ica_ica_connection_proto_rawDescData)
	})
	return file_sourcehub_ica_ica_connection_proto_rawDescData
}

var file_sourcehub_ica_ica_connection_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sourcehub_ica_ica_connection_proto_goTypes = []interface{}{
	(*ICAConnection)(nil), // 0: sourcehub.ica.ICAConnection
}
var file_sourcehub_ica_ica_connection_proto_depIdxs = []int32{
...
func init() { file_sourcehub_ica_ica_connection_proto_init() }
func file_sourcehub_ica_ica_connection_proto_init() {
	if File_sourcehub_ica_ica_connection_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sourcehub_ica_ica_connection_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sourcehub_ica_ica_connection_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sourcehub_ica_ica_connection_proto_goTypes,
		DependencyIndexes: file_sourcehub_ica_ica_connection_proto_depIdxs,
		MessageInfos:      file_sourcehub_ica_ica_connection_proto_msgTypes,
	}.Build()
	File_sourcehub_ica_ica_connection_proto = out.File
	file_sourcehub_ica_ica_connection_proto_rawDesc = nil
	file_sourcehub_ica_ica_connection_proto_goTypes = nil
	file_sourcehub_ica_ica_connection_proto_depIdxs = nil
}
