...
func init() {
	file_sourcehub_bulletin_events_proto_init()
	md_EventPostUpdated = File_sourcehub_bulletin_events_proto.Messages().ByName("EventPostUpdated")
...
func (x *fastReflection_EventPostUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sourcehub.bulletin.EventPostUpdated.namespace_id":
		return x.NamespaceId != ""
	case "sourcehub.bulletin.EventPostUpdated.post_id":
		return x.PostId != ""
	case "sourcehub.bulletin.EventPostUpdated.updater_did":
		return x.UpdaterDid != ""
	case "sourcehub.bulletin.EventPostUpdated.payload":
		return x.Payload != ""
	case "sourcehub.bulletin.EventPostUpdated.artifact":
		return x.Artifact != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.bulletin.EventPostUpdated"))
		}
		panic(fmt.Errorf("message sourcehub.bulletin.EventPostUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventPostUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sourcehub.bulletin.EventPostUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventPostUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sourcehub.bulletin.EventPostUpdated.namespace_id":
		panic(fmt.Errorf("field namespace_id of message sourcehub.bulletin.EventPostUpdated is not mutable"))
	case "sourcehub.bulletin.EventPostUpdated.post_id":
		panic(fmt.Errorf("field post_id of message sourcehub.bulletin.EventPostUpdated is not mutable"))
	case "sourcehub.bulletin.EventPostUpdated.updater_did":
		panic(fmt.Errorf("field updater_did of message sourcehub.bulletin.EventPostUpdated is not mutable"))
	case "sourcehub.bulletin.EventPostUpdated.payload":
		panic(fmt.Errorf("field payload of message sourcehub.bulletin.EventPostUpdated is not mutable"))
	case "sourcehub.bulletin.EventPostUpdated.artifact":
		panic(fmt.Errorf("field artifact of message sourcehub.bulletin.EventPostUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.bulletin.EventPostUpdated"))
		}
...
func (x *fastReflection_EventPostUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sourcehub.bulletin.EventPostUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *EventCollaboratorRemoved) slowProtoReflect() protoreflect.Message {
	mi := &file_sourcehub_bulletin_events_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*EventCollaboratorRemoved) Descriptor() ([]byte, []int) {
	return file_sourcehub_bulletin_events_proto_rawDescGZIP(), []int{4}
}
...
var file_sourcehub_bulletin_events_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x22, 0xa5, 0x01, 0x0a, 0x10, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x50, 0x6f, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x6e,
	...
	,
	...
	0x64, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74, 0x6f,
	0x72, 0x5f, 0x64, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x63, 0x6f, 0x6c,
	0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x69, 0x64, 0x42, 0xb3, 0x01, 0x0a,
	0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2e, 0x62,
	0x75, 0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50,
	...
	0x75, 0x62, 0x2f, 0x62, 0x75, 0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0xa2, 0x02, 0x03, 0x53, 0x42,
	0x58, 0xaa, 0x02, 0x12, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2e, 0x42, 0x75,
	0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0xca, 0x02, 0x12, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68,
	0x75, 0x62, 0x5c, 0x42, 0x75, 0x6c, 0x6c, 0x65, 0x74, 0x69, 0x6e, 0xe2, 0x02, 0x1e, 0x53, 0x6f,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x3a, 0x3a, 0x42, 0x75, 0x6c, 0x6c, 0x65, 0x74,
...
var file_sourcehub_bulletin_events_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_sourcehub_bulletin_events_proto_goTypes = []interface{}{
	...
	(*EventPostUpdated)(nil),         // 2: sourcehub.bulletin.EventPostUpdated
	(*EventCollaboratorAdded)(nil),   // 3: sourcehub.bulletin.EventCollaboratorAdded
	(*EventCollaboratorRemoved)(nil), // 4: sourcehub.bulletin.EventCollaboratorRemoved
	(*timestamppb.Timestamp)(nil),    // 5: google.protobuf.Timestamp
}
var file_sourcehub_bulletin_events_proto_depIdxs = []int32{
	5, // 0: sourcehub.bulletin.EventNamespaceRegistered.created_at:type_name -> google.protobuf.Timestamp
...
func file_sourcehub_bulletin_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sourcehub_bulletin_events_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
