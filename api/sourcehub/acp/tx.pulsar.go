...
var (
	md_MsgMsgEditPolicy          protoreflect.MessageDescriptor
	fd_MsgMsgEditPolicy_creator  protoreflect.FieldDescriptor
	fd_MsgMsgEditPolicy_policyId protoreflect.FieldDescriptor
)

func init() {
	file_sourcehub_acp_tx_proto_init()
	md_MsgMsgEditPolicy = File_sourcehub_acp_tx_proto.Messages().ByName("MsgMsgEditPolicy")
	fd_MsgMsgEditPolicy_creator = md_MsgMsgEditPolicy.Fields().ByName("creator")
	fd_MsgMsgEditPolicy_policyId = md_MsgMsgEditPolicy.Fields().ByName("policyId")
}

var _ protoreflect.Message = (*fastReflection_MsgMsgEditPolicy)(nil)

type fastReflection_MsgMsgEditPolicy MsgMsgEditPolicy

func (x *MsgMsgEditPolicy) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgMsgEditPolicy)(x)
}

func (x *MsgMsgEditPolicy) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgMsgEditPolicy_messageType fastReflection_MsgMsgEditPolicy_messageType
var _ protoreflect.MessageType = fastReflection_MsgMsgEditPolicy_messageType{}

type fastReflection_MsgMsgEditPolicy_messageType struct{}

func (x fastReflection_MsgMsgEditPolicy_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgMsgEditPolicy)(nil)
}
func (x fastReflection_MsgMsgEditPolicy_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgMsgEditPolicy)
}
func (x fastReflection_MsgMsgEditPolicy_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgMsgEditPolicy
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgMsgEditPolicy) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgMsgEditPolicy
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgMsgEditPolicy) Type() protoreflect.MessageType {
	return _fastReflection_MsgMsgEditPolicy_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgMsgEditPolicy) New() protoreflect.Message {
	return new(fastReflection_MsgMsgEditPolicy)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgMsgEditPolicy) Interface() protoreflect.ProtoMessage {
	return (*MsgMsgEditPolicy)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgMsgEditPolicy) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Creator != "" {
		value := protoreflect.ValueOfString(x.Creator)
		if !f(fd_MsgMsgEditPolicy_creator, value) {
			return
		}
	}
	if x.PolicyId != "" {
		value := protoreflect.ValueOfString(x.PolicyId)
		if !f(fd_MsgMsgEditPolicy_policyId, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgMsgEditPolicy) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sourcehub.acp.MsgMsgEditPolicy.creator":
		return x.Creator != ""
	case "sourcehub.acp.MsgMsgEditPolicy.policyId":
		return x.PolicyId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicy"))
		}
		panic(fmt.Errorf("message sourcehub.acp.MsgMsgEditPolicy does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicy) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "sourcehub.acp.MsgMsgEditPolicy.creator":
		x.Creator = ""
	case "sourcehub.acp.MsgMsgEditPolicy.policyId":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgMsgEditPolicy) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "sourcehub.acp.MsgMsgEditPolicy.creator":
		value := x.Creator
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message sourcehub.acp.MsgMsgEditPolicy does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicy) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "sourcehub.acp.MsgMsgEditPolicy.creator":
		x.Creator = value.Interface().(string)
	case "sourcehub.acp.MsgMsgEditPolicy.policyId":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicy) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sourcehub.acp.MsgMsgEditPolicy.creator":
		panic(fmt.Errorf("field creator of message sourcehub.acp.MsgMsgEditPolicy is not mutable"))
	case "sourcehub.acp.MsgMsgEditPolicy.policyId":
		panic(fmt.Errorf("field policyId of message sourcehub.acp.MsgMsgEditPolicy is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicy"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgMsgEditPolicy) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sourcehub.acp.MsgMsgEditPolicy.creator":
		return protoreflect.ValueOfString("")
	case "sourcehub.acp.MsgMsgEditPolicy.policyId":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgMsgEditPolicy) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sourcehub.acp.MsgMsgEditPolicy", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgMsgEditPolicy) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicy) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgMsgEditPolicy) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgMsgEditPolicy) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgMsgEditPolicy)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgMsgEditPolicy: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgMsgEditPolicy: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgMsgEditPolicyResponse protoreflect.MessageDescriptor
)

func init() {
	file_sourcehub_acp_tx_proto_init()
	md_MsgMsgEditPolicyResponse = File_sourcehub_acp_tx_proto.Messages().ByName("MsgMsgEditPolicyResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgMsgEditPolicyResponse)(nil)

type fastReflection_MsgMsgEditPolicyResponse MsgMsgEditPolicyResponse

func (x *MsgMsgEditPolicyResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgMsgEditPolicyResponse)(x)
}

func (x *MsgMsgEditPolicyResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgMsgEditPolicyResponse_messageType fastReflection_MsgMsgEditPolicyResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgMsgEditPolicyResponse_messageType{}

type fastReflection_MsgMsgEditPolicyResponse_messageType struct{}

func (x fastReflection_MsgMsgEditPolicyResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgMsgEditPolicyResponse)(nil)
}
func (x fastReflection_MsgMsgEditPolicyResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgMsgEditPolicyResponse)
}
func (x fastReflection_MsgMsgEditPolicyResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgMsgEditPolicyResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgMsgEditPolicyResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgMsgEditPolicyResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgMsgEditPolicyResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgMsgEditPolicyResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgMsgEditPolicyResponse) New() protoreflect.Message {
	return new(fastReflection_MsgMsgEditPolicyResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgMsgEditPolicyResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgMsgEditPolicyResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgMsgEditPolicyResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgMsgEditPolicyResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicyResponse"))
		}
		panic(fmt.Errorf("message sourcehub.acp.MsgMsgEditPolicyResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicyResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicyResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgMsgEditPolicyResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicyResponse"))
		}
		panic(fmt.Errorf("message sourcehub.acp.MsgMsgEditPolicyResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicyResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicyResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicyResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicyResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgMsgEditPolicyResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sourcehub.acp.MsgMsgEditPolicyResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgMsgEditPolicyResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sourcehub.acp.MsgMsgEditPolicyResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgMsgEditPolicyResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgMsgEditPolicyResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgMsgEditPolicyResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgMsgEditPolicyResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgMsgEditPolicyResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgMsgEditPolicyResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgMsgEditPolicyResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
func (MsgSignedPolicyCmd_ContentType) EnumDescriptor() ([]byte, []int) {
	return file_sourcehub_acp_tx_proto_rawDescGZIP(), []int{6, 0}
}
...
func (x *MsgMsgEditPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgMsgEditPolicy) ProtoMessage() {}

// Deprecated: Use MsgMsgEditPolicy.ProtoReflect.Descriptor instead.
func (*MsgMsgEditPolicy) Descriptor() ([]byte, []int) {
	return file_sourcehub_acp_tx_proto_rawDescGZIP(), []int{12}
}

func (x *MsgMsgEditPolicy) GetCreator() string {
	if x != nil {
		return x.Creator
	}
	return ""
...
func (x *MsgMsgEditPolicy) GetPolicyId() string {
	if x != nil {
		return x.PolicyId
	}
	return ""
...
type MsgMsgEditPolicyResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *MsgMsgEditPolicyResponse) Reset() {
	*x = MsgMsgEditPolicyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sourcehub_acp_tx_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgMsgEditPolicyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgMsgEditPolicyResponse) ProtoMessage() {}

// Deprecated: Use MsgMsgEditPolicyResponse.ProtoReflect.Descriptor instead.
func (*MsgMsgEditPolicyResponse) Descriptor() ([]byte, []int) {
...
var file_sourcehub_acp_tx_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x24, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x6e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x61, 0x63, 0x70, 0x5f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1a, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2f, 0x61, 0x63, 0x70, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68,
	...
	0x6f, 0x74, 0x6f, 0x1a, 0x23, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x68, 0x75, 0x62, 0x2f, 0x61,
	0x63, 0x70, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x64, 0x65, 0x63, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x29, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x63, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb7, 0x01, 0x0a, 0x0f, 0x4d, 0x73, 0x67,
	...
	0x72, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x0e, 0x4d, 0x73, 0x67, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72,
	...
	0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x3a, 0x0c, 0x82, 0xe7, 0xb0, 0x2a,
	0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x53, 0x0a, 0x16, 0x4d, 0x73, 0x67, 0x43,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x08, 0x64, 0x65, 0x63, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xbe, 0x01,
	0x0a, 0x12, 0x4d, 0x73, 0x67, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	,
	...
	0x63, 0x79, 0x43, 0x6d, 0x64, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x22, 0x56, 0x0a, 0x10, 0x4d, 0x73, 0x67, 0x4d, 0x73, 0x67, 0x45, 0x64, 0x69,
	...
	0x72, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x49, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x49, 0x64, 0x3a, 0x0c, 0x82,
	0xe7, 0xb0, 0x2a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x1a, 0x0a, 0x18, 0x4d,
	0x73, 0x67, 0x4d, 0x73, 0x67, 0x45, 0x64, 0x69, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8f, 0x05, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x59, 0x0a, 0x0d, 0x4d, 0x73, 0x67, 0x45, 0x64,
	0x69, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x1f, 0x2e, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x68, 0x75, 0x62, 0x2e, 0x61, 0x63, 0x70, 0x2e, 0x4d, 0x73, 0x67, 0x4d, 0x73, 0x67, 0x45,
	0x64, 0x69, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a, 0x27, 0x2e, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x68, 0x75, 0x62, 0x2e, 0x61, 0x63, 0x70, 0x2e, 0x4d, 0x73, 0x67, 0x4d, 0x73, 0x67,
	0x45, 0x64, 0x69, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_sourcehub_acp_tx_proto_goTypes = []interface{}{
	...
	(*MsgCheckAccess)(nil),              // 5: sourcehub.acp.MsgCheckAccess
	(*MsgCheckAccessResponse)(nil),      // 6: sourcehub.acp.MsgCheckAccessResponse
	(*MsgSignedPolicyCmd)(nil),          // 7: sourcehub.acp.MsgSignedPolicyCmd
	(*MsgSignedPolicyCmdResponse)(nil),  // 8: sourcehub.acp.MsgSignedPolicyCmdResponse
	(*MsgBearerPolicyCmd)(nil),          // 9: sourcehub.acp.MsgBearerPolicyCmd
	(*MsgBearerPolicyCmdResponse)(nil),  // 10: sourcehub.acp.MsgBearerPolicyCmdResponse
	(*MsgDirectPolicyCmd)(nil),          // 11: sourcehub.acp.MsgDirectPolicyCmd
	(*MsgDirectPolicyCmdResponse)(nil),  // 12: sourcehub.acp.MsgDirectPolicyCmdResponse
	(*MsgMsgEditPolicy)(nil),            // 13: sourcehub.acp.MsgMsgEditPolicy
	(*MsgMsgEditPolicyResponse)(nil),    // 14: sourcehub.acp.MsgMsgEditPolicyResponse
...
var file_sourcehub_acp_tx_proto_depIdxs = []int32{
	...
	18, // 3: sourcehub.acp.MsgCheckAccess.access_request:type_name -> sourcenetwork.acp_core.AccessRequest
	19, // 4: sourcehub.acp.MsgCheckAccessResponse.decision:type_name -> sourcehub.acp.AccessDecision
	0,  // 5: sourcehub.acp.MsgSignedPolicyCmd.type:type_name -> sourcehub.acp.MsgSignedPolicyCmd.ContentType
	20, // 6: sourcehub.acp.MsgSignedPolicyCmdResponse.result:type_name -> sourcehub.acp.PolicyCmdResult
	21, // 7: sourcehub.acp.MsgBearerPolicyCmd.cmd:type_name -> sourcehub.acp.PolicyCmd
	20, // 8: sourcehub.acp.MsgBearerPolicyCmdResponse.result:type_name -> sourcehub.acp.PolicyCmdResult
	21, // 9: sourcehub.acp.MsgDirectPolicyCmd.cmd:type_name -> sourcehub.acp.PolicyCmd
	20, // 10: sourcehub.acp.MsgDirectPolicyCmdResponse.result:type_name -> sourcehub.acp.PolicyCmdResult
	1,  // 11: sourcehub.acp.Msg.UpdateParams:input_type -> sourcehub.acp.MsgUpdateParams
	3,  // 12: sourcehub.acp.Msg.CreatePolicy:input_type -> sourcehub.acp.MsgCreatePolicy
	5,  // 13: sourcehub.acp.Msg.CheckAccess:input_type -> sourcehub.acp.MsgCheckAccess
	7,  // 14: sourcehub.acp.Msg.SignedPolicyCmd:input_type -> sourcehub.acp.MsgSignedPolicyCmd
	9,  // 15: sourcehub.acp.Msg.BearerPolicyCmd:input_type -> sourcehub.acp.MsgBearerPolicyCmd
	11, // 16: sourcehub.acp.Msg.DirectPolicyCmd:input_type -> sourcehub.acp.MsgDirectPolicyCmd
	13, // 17: sourcehub.acp.Msg.MsgEditPolicy:input_type -> sourcehub.acp.MsgMsgEditPolicy
	2,  // 18: sourcehub.acp.Msg.UpdateParams:output_type -> sourcehub.acp.MsgUpdateParamsResponse
	4,  // 19: sourcehub.acp.Msg.CreatePolicy:output_type -> sourcehub.acp.MsgCreatePolicyResponse
	6,  // 20: sourcehub.acp.Msg.CheckAccess:output_type -> sourcehub.acp.MsgCheckAccessResponse
	8,  // 21: sourcehub.acp.Msg.SignedPolicyCmd:output_type -> sourcehub.acp.MsgSignedPolicyCmdResponse
	10, // 22: sourcehub.acp.Msg.BearerPolicyCmd:output_type -> sourcehub.acp.MsgBearerPolicyCmdResponse
	12, // 23: sourcehub.acp.Msg.DirectPolicyCmd:output_type -> sourcehub.acp.MsgDirectPolicyCmdResponse
	14, // 24: sourcehub.acp.Msg.MsgEditPolicy:output_type -> sourcehub.acp.MsgMsgEditPolicyResponse
...
func file_sourcehub_acp_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sourcehub_acp_tx_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgMsgEditPolicyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
